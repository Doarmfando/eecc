...
// Sin esto, el `.env` del desarrollador decide en qué modo corren las pruebas y la
// suite del modo con base de datos falla en una máquina configurada sin persistencia.
// `test/ephemeral-env.ts` lo pisa con una asignación directa para su propia suite.
